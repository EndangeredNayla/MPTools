...
$CLIENT_MODS_TO_REMOVE_FROM_SERVER_FILES = "mod.jar", "mod2.jar"

# A continuous line of the folders and files (with extensions) to zip into Server Files.
# Default: "config", "mods", "resources", "kubejs", "scripts"
$SERVER_CONTENTS_TO_ZIP = "config", "mods", "resources", "kubejs", "scripts"
